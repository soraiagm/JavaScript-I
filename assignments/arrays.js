...
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
 let carModels = inventory.sort(function(a1, a2){
    if(a1.car_model > a2.car_model){
        return 1;
    }else{
        return -1;
    }
...
let carYears = inventory.map(function(id){
    return id.car_year;
});
...
let BMWAndAudi = inventory.filter(function(id) {
    if(id.car_make === 'BMW') {
            return true;
    }
